 ...
 *   https://datatables.net/download/#bs4/dt-1.10.24/cr-1.5.3/date-1.0.3/kt-2.6.1
 *
 * Included libraries:
 *   DataTables 1.10.24, ColReorder 1.5.3, DateTime 1.0.3, KeyTable 2.6.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.24/cr-1.5.3/date-1.0.3/kt-2.6.1",
