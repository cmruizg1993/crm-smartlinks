...
class EmpresaController extends AbstractController
{
    ...
    public function edit(Request $request, Empresa $empresa, EntityManagerInterface $entityManager): Response
    {
        ...
        /* @var $usuarioEmpresa Empresa */
        $usuarioEmpresa = $this->getUser()->getEmpresa();
        if($empresa->getId() != $usuarioEmpresa->getId() && !$this->isGranted('ROLE_SUPER_ADMIN')) return new Response(null,Response::HTTP_UNAUTHORIZED);
