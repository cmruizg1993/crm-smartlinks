 ...
 */
final class Version20221103201434 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE estado_contrato ADD CONSTRAINT FK_979FD6CE70AE7BF1 FOREIGN KEY (contrato_id) REFERENCES contrato (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
