...
final class Version20221102040118 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE configuracion ADD obligado_contabilidad VARCHAR(2) NOT NULL, DROP nombre_configuracion');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE configuracion ADD nombre_configuracion VARCHAR(255) NOT NULL, DROP obligado_contabilidad');
