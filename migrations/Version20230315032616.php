 ...
 */
final class Version20230315032616 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE punto_emision ADD CONSTRAINT FK_74905531A9B5E49A FOREIGN KEY (tipo_comprobante_id) REFERENCES tipo_comprobante (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
