...
final class Version20210507233616 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE solicitud_plan ADD CONSTRAINT FK_E195105BE899029B FOREIGN KEY (plan_id) REFERENCES plan (id) ON UPDATE NO ACTION ON DELETE CASCADE');
    }
}
