...
final class Version20221003165229 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE configuracion (id INT AUTO_INCREMENT NOT NULL, nombre_configuracion VARCHAR(255) NOT NULL, razon_social VARCHAR(255) DEFAULT NULL, nombre_comercial VARCHAR(255) DEFAULT NULL, ruc VARCHAR(13) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, telefono VARCHAR(15) DEFAULT NULL, direccion VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
